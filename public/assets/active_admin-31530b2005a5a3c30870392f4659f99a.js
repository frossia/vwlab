...
(function() {
  jQuery(function() {
    ...
    $('#select_all_generations').click(function() {
      return $('.destroy_generation').prop("checked", true);
    });
    return $('#deselect_all_generations').click(function() {
      return $('.destroy_generation').prop("checked", false);
    });
  });
